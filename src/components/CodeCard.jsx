...
const CodeCard = ({ data, variableName = "dev" }) => {
    ...
    return (
        <div className="w-full rounded-xl overflow-hidden border border-neutral-200 dark:border-neutral-800 shadow-lg bg-neutral-50 dark:bg-zinc-900 text-xs sm:text-sm group relative">
            ...
            <div className="flex mx-3 mt-3 sm:ml-6 w-fit rounded overflow-hidden items-center">
                <div
                ...
                >
                    ...
                    <span className="hidden min-[470px]:block">JavaScript</span>
                </div>
                <div
                ...
                >
                    ...
                    <span className="hidden min-[470px]:block">Terminal</span>
                </div>
                <div
                ...
                >
                    ...
                    <span className="hidden min-[470px]:block">Markdown</span>
                </div>
            </div>
