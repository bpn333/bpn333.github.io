        ...
        <div className="w-full rounded-xl overflow-hidden border border-neutral-200 dark:border-neutral-800 shadow-lg bg-neutral-50 dark:bg-zinc-900 text-xs sm:text-sm group relative">
            <div className="flex items-center justify-between px-4 py-3 bg-neutral-200 dark:bg-zinc-950 border-b border-neutral-200 dark:border-neutral-800">
                <div className="flex gap-2">
                    ...
                    <span className="w-3 h-3 rounded-full bg-yellow-400 hover:bg-yellow-700" onClick={() => document.exitFullscreen()} />
            ...
            <div className="flex mx-3 mt-3 sm:ml-6 sm:w-fit rounded overflow-hidden items-center">
                <div
                    className={`flex p-5 border-b-2 cursor-pointer h-5 gap-3 items-center ${currentTab == 0 ? "border-amber-300 bg-neutral-200 dark:bg-zinc-800" : "border-b-transparent bg-neutral-100 dark:bg-zinc-950"}`}
                    onClick={() => setCurrentTab(0)}
                >
                    <span className="fill-amber-300 w-5">
                ...
                <div
                    className={`flex p-5 border-b-2 cursor-pointer h-5 gap-3 items-center ${currentTab == 1 ? "border-green-600 bg-neutral-200 dark:bg-zinc-800" : "border-b-transparent bg-neutral-100 dark:bg-zinc-950"}`}
                ...
                <div
                    className={`flex p-5 border-b-2 cursor-pointer h-5 gap-3 items-center ${currentTab == 2 ? "border-blue-500 bg-neutral-200 dark:bg-zinc-800" : "border-b-transparent bg-neutral-100 dark:bg-zinc-950"}`}
                    onClick={() => setCurrentTab(2)}
                >
                    <span className="fill-blue-500 w-5">
